...
```mermaid
graph TD;
    A[INDEX.HTML] -->|Gateway| B(HERO SECTION);
    B --> C{NAVIGATION};
    C -->|Identity| D[WORK-IDENTITY.HTML];
    C -->|Visual| E[WORK-VISUAL.HTML];
    C -->|Tactile| F[WORK-PACKAGING.HTML];
    C -->|Digital| G[WORK-DIGITAL.HTML];
    
    style A fill:#D4AF37,stroke:#333,stroke-width:2px,color:#000
    style B fill:#111,stroke:#D4AF37,stroke-width:1px,color:#fff
    style C fill:#111,stroke:#fff,stroke-width:1px,color:#fff
```
